...
namespace DWS_LPMWC_Deps\DI\Proxy;

use DWS_LPMWC_Deps\ProxyManager\Configuration;
use DWS_LPMWC_Deps\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use DWS_LPMWC_Deps\ProxyManager\FileLocator\FileLocator;
use DWS_LPMWC_Deps\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use DWS_LPMWC_Deps\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use DWS_LPMWC_Deps\ProxyManager\Proxy\LazyLoadingInterface;
/**
